...
void Check_TFT_Serial_Input() {
	...
	if (SerialCom3.update ())
	{
	  ...
	  if (recvBuff[0] == 21) {
		  ...
		  message_out.print(F("|TFTserIn:OK|"));
...
if (TFT_Menu_Command == 31) message_out.println(F("PIXHAWK Go Menu"));
if (TFT_Menu_Command == 32) message_out.println(F("GPS Main Menu"));
...
if (TFT_Menu_Command == 56) message_out.println(F("Start-Up Value Date"));
if (TFT_Menu_Command == 57) message_out.println(F("TX Docked Info"));
if (TFT_Menu_Command == 58) message_out.println(F("Mower Running"));
if (TFT_Menu_Command == 59) message_out.println(F("Test Lift Mechanism"));
if (TFT_Menu_Command == 60) message_out.println(F("Test Lift Mechanism UP"));
if (TFT_Menu_Command == 61) message_out.println(F("Test Lift Mechanism DOWN"));
if (TFT_Menu_Command == 62) message_out.println(F("Initiate Drill Test"));
if (TFT_Menu_Command == 63) message_out.println(F("PIXHAWK Test"));
if (TFT_Menu_Command == 64) message_out.println(F("Start PWM Read"));
if (TFT_Menu_Command == 65) message_out.println(F("Wheel Test Method 2"));
if (TFT_Menu_Command == 66) message_out.println(F("Left Front Forwards"));
if (TFT_Menu_Command == 67) message_out.println(F("Left Front Backwards"));
if (TFT_Menu_Command == 68) message_out.println(F("Right Front Forwards"));
if (TFT_Menu_Command == 69) message_out.println(F("Right Front Backwards"));
if (TFT_Menu_Command == 70) message_out.println(F("Left Rear Forwards"));
if (TFT_Menu_Command == 71) message_out.println(F("Left Rear Backwards"));
if (TFT_Menu_Command == 72) message_out.println(F("Right Rear Forwards"));
if (TFT_Menu_Command == 73) message_out.println(F("Right Rear Backwards"));
if (TFT_Menu_Command == 74) message_out.println(F("Right Rear Backwards"));
if (TFT_Menu_Command == 75) message_out.println(F("Right Rear Backwards"));
