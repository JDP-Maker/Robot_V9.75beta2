...
// Thanks to Radek Veselý for help with thw code speed up, improved serial communication
...
//******************* added by JDP *************************************************************************
// this defines the pins that will be used to collect data using ADCman rather than the Nano JDP
#define Battery_Amps A11 	// Charge Amps JDP
#define Battery_Volts A12 	// Battery Volts JDP
#define Wheel_Amps A13		// Wheel Amps JDP
#define Rain_Sensor A14		//Rain Sensor JDP
//JDP**********************************************************************************************************
...
// Pattern Spiral
int    Max_Cycles_Spirals    = 50000;      // Overrides the Max_Cycles for straight line mowing as the spirals requires more loops to complete
