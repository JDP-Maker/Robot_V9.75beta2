...
message_out.println("Loading dueFlashStorage Settings");
  ...
  if (Robot_Type_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Robot_Type: "));
    if (Robot_Type == 1) message_out.println(F("FLASH: Robot Type = Mower"));
    if (Robot_Type == 2) message_out.println(F("FLASH: Robot Type = Aerator"));
  }
  ...
  if (PCB_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PCB Enabled: "));
  ...
  if (Alarm_1_Saved_dueFlashStorage == 1) {
    ...
    if (Alarm_1_ON == 1) {
      message_out.print(F("dueFlashStorage Alarm 1 Active | Time Set:"));
  ...
  if (PWM_LEFT_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PWM Wheel Left value : "));
  ...
  if (PWM_RIGHT_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PWM Wheel Right value: ")); 
  ...
  if (PWM_LEFT_Slow_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PWM Wheel Slow Left value: "));
  ...
  if (PWM_RIGHT_Slow_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PWM Wheel Slow Right value: ")); 
  ...
  if (Slow_Speed_MAG_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Slow Speed MAG: ")); 
 ...
 if (Slow_Speed_MAG_dueFlashStorage == 1) {
  ...
  if (PWM_BLADE_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: PWM Blade value: ")); 
  ...
  if (COMPASS_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Compass Activated: "));
  ...
  if (COMPASS_Setup_Mode_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Compass Setup Mode: "));
  ...
  if (Compass_Heading_Hold_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Compass Heading Hold: "));
  ...
  if (CPower_dueFlashStorage == 1) {
    ...
    CPower = CPower / 10; 
    message_out.print(F("FLASH: Compass Power: "));
  ...
  if (Compass_Home_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Compass Home Degrees : ")); 
 ...
 int Tracking_PID_P_dueFlashStorage = dueFlashStorage.read(21);
  if (Tracking_PID_P_dueFlashStorage == 1) {
    ...
    P = P / 100; 
    message_out.print(F("FLASH: Traking PID P: "));
  ...
  if (Pattern_Mow_dueFlashStorage == 1) {
    ...
    //Pattern_Mow = 1;
    message_out.print(F("FLASH: Pattern Mow Type: "));
  ...
  if (Minimum_Volt_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Minimum Battery Voltage: "));
  ...
  if (Angle_Sensor_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Angle Sensor Enabled: "));
  ...
  if (Tip_Over_Sensor_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("dueFlashStorage Tip Sensor Enabled:  "));
  ...
  if (Mower_Turn_Delay_Min_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Mower Turn Delay Min: "));
  ...
  if (Mower_Turn_Delay_Max_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Mower Turn Delay Max: "));
  ...
  if (Mower_Reverse_Delay_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Mower Reverse Time Delay/ms: "));
  ...
  if (Track_Wire_Zone_1_Cycles_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Zone 1 Tracking Cycles "));
  ...
  if (Track_Wire_Zone_2_Cycles_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Zone 2 Tracking Cycles "));
  ...
  if (Use_Charging_Station_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Charge Station: "));
  ...
  if (CW_Tracking_To_Charge_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Tracking Direction to Charge : "));
  ...
  if (CCW_Tracking_To_Charge_dueFlashStorage == 1) {
    ...
    message_out.print(F("dueFlashStorage Tracking Direction to Charge : "));
  ...
  if (CW_Tracking_To_Start_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Tracking Direction to Start : "));
  ...
  if (Max_Cycles_Straight_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Straight Line Cycles before turn: "));
  ...
  if (Sonar_1_Activate_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Sonar 1 Activated: "));
  ...
  if (Sonar_2_Activate_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Sonar 2 Activated: "));
  ...
  if (Sonar_3_Activate_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Sonar 3 Activated: "));
  ...
  if (Max_Sonar_Hit_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Sonar Sensitivity: "));
  ...
  if (maxdistancesonar_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Sonar Activation Distance: "));
  ...
  if (Perimeter_Wire_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Wire Module ON/OFF: "));
  ...
  if (Max_Cycle_Wire_Find_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Track Cycles Forwards to find Wire "));
  ...
  if (Max_Cycle_Wire_Find_Back_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Track Cycles Back to find Wire "));
  ...
  if (Max_Tracking_Turn_Right_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Wheel RH Cycles before restart "));
  ...
  if (Max_Tracking_Turn_Left_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Wheel LH Cycles before restart "));
  ...
  if (Rain_Sensor_Installed_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Rain Sensor ON/OFF:  "));
  ...
  if (WIFI_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: WIFI Enabled: "));
  ...
  if (Cutting_Blades_Activate_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: CUTTING BLADE Motor SET TO : "));
  ...
  if (Low_Battery_Instances_Chg_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Battery to Charge Sensitivity: "));
  ...
  if (Bumper_Activate_Frnt_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Bumper Bar Enabled: "));
  ...
  if (Turn_90_Delay_LH_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Turn_90_Delay_LH Enabled: "));
  ...
  if (Turn_90_Delay_RH_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Turn_90_Delay_RH Enabled: "));
  ...
  if (Line_Length_Cycles_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Line_Length_Cycles Enabled: "));
  ...
  if (GYRO_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: GYRO Enabled: "));
  ...
  if (GPower_dueFlashStorage == 1) {
    ...
    GPower = GPower / 10; 
    message_out.print(F("FLASH: GYRO PID : "));
  ...
  if (Wheel_Amp_Sensor_ON_Enabled_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Wheel Block Amp Sensor Enabled: "));
  ...
  if (Max_Wheel_Amps_dueFlashStorage == 1) {
    ...
    message_out.print(F("FLASH: Wheel Block Amps: "));
