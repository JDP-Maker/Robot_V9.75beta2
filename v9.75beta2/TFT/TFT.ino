...
#define SerialMEGA Serial3              // Serial port for communication with Mower Mega
...
if ((Robot_Status_Value == 1) || (Robot_Status_Value == 2)) {
    ...
    while (Menu_Complete_Main == false) {
              ...
              if ((Robot_Status_Value == 4) || (Robot_Status_Value == 5) || (Robot_Status_Value == 7) || (Robot_Status_Value == 9)) {
                  Serial.print(F("Mower Status Command Received:"));
...
//Mower Detected Rain
//*************************************************************************************************
if (Robot_Status_Value == 8) {
      Serial.println(F("Mower detected Rain"));
      Menu_Active = 94;
      Send_Menu_Selected_To_Mower_MEGA();         // Tell the Mower MEGA which menu on the TFT is selected
      Menu_Complete_Mowing = true;
      Robot_Status_Value = 7;    //TODO: not working when Use_Charging_Station=0 -> because Robot_Status_Value=2 when Parked
      }
