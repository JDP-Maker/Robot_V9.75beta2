...
void Transmit_Setup_Other_Values() {
      ...
      if (Clear_EEPROM == 5) Serial.println(F("CLEAR EEPROM SIGNAL SENT TO MEGA"));
      Clear_EEPROM = 0;
      Serial.println(" ");
      }
...
void Transmit_GPS_Menu_Values() {
      Serial.println("GPS Menu Values");
      Data1 = GPS_Enabled;
      Data2 = GPS_Type;
      Data3 = 0;
      Data4 = 0;
...
void Transmit_Saved_GPS_Values() {
      ...
      SerialMEGA.print(GPS_Enabled);
      SerialMEGA.println("\d");
      delay(200);  
